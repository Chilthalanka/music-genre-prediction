...
class Lemmatizer(Transformer,               # Base class
    ...
    """
    Custom transformer wrapper class for lemmatizing the text
    """
    ...
    def _transform(self, df: DataFrame):
        ...
        lemmatizer_udf = udf(lambda tokens: [lemmatizer.lemmatize(token) for token in tokens],
                             ArrayType(StringType()))

        return df.withColumn(outputCol, lemmatizer_udf(col(inputCol)))

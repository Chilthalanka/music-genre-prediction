...
class Uniter(Transformer,               # Base class
    ...
    """
    Custom transformer wrapper class for uniting the tokens back
    """
    ...
    def _transform(self, df: DataFrame):
        ...
        uniter_udf = udf(lambda tokens: ' '.join(tokens), StringType())

        return df.withColumn(outputCol, uniter_udf(col(inputCol)))
